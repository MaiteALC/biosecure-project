...
public class ProductTest {
    ...
    public void shouldThrowException_WhenProductAttributeIsInvalid()  {
        InvalidProductAttributeException priceException = assertThrows(InvalidProductAttributeException.class, () -> {
            ProductBuilder.aProduct().withPrice(0).build();
        });
        
        InvalidProductAttributeException priceException2 = assertThrows(InvalidProductAttributeException.class, () -> {
        ...
        InvalidProductAttributeException quantityException = assertThrows(InvalidProductAttributeException.class, () ->{
            ProductBuilder.aProduct().withQuantityPerPackage(0).build();
        });
        
        InvalidProductAttributeException quantityException2 = assertThrows(InvalidProductAttributeException.class, () -> {
