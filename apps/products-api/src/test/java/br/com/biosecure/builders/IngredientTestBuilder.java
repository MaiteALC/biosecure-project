...
public class IngredientTestBuilder {
    ...
    public IngredientTestBuilder withCasNumber(String casNumber) {
        this.casNumber = casNumber;
        return this;
    }

    public IngredientTestBuilder withChemicalBase(ChemicalFamily chemicalFamily) {
    ...
    public IngredientTestBuilder withConcentrationPercentual(double concentrationPercentual) {
        this.concentrationPercentual = concentrationPercentual;
        return this;
    }

    public IngredientTestBuilder withFunction(Ingredient.IngredientType function) {
        this.function = function;
        return this;
    }

    public static IngredientTestBuilder anActiveIngredient() {
