...
import br.com.biosecure.model.Sanitizer.ConcentrationUnit;
...
public class SanitizerTest {
    ...
    public void shouldThrowException_WhenProductAttributeIsInvalid() {
        ...
        InvalidProductAttributeException concentrationException = assertThrows(InvalidProductAttributeException.class, () -> {
            ...
            .withConcentrationUnit(ConcentrationUnit.PARTS_PER_MILLION)
            .build();
        });
        ...
        InvalidProductAttributeException concentrationException2 = assertThrows(InvalidProductAttributeException.class, () -> {
            ...
            .withConcentrationUnit(ConcentrationUnit.GAY_LUSSAC) // default chemical base == QUATERNARY_AMMONIUM. This will be invalidated concentration unit and concentration at same time
            .build();
        });
        ...
        InvalidProductAttributeException concentrationException4 = assertThrows(InvalidProductAttributeException.class, () -> {
            ...
            .withConcentrationUnit(ConcentrationUnit.MILLIGRAMS_PER_LITER)
            .build();
        });
    ...
    public void shouldConvertUnitsCorrectly() {
        ...
        assertEquals(4650, anotherSanitizer2.convertConcentrationUnit(ConcentrationUnit.MILLIGRAMS_PER_LITER));
