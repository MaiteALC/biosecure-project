...
public class SKU {
    ...
    private String generateFor(Product product) {
        ...
        if ( !product.getPackagingType().getCode().equals("INDV")) {
    ...
    private void incrementForPpe(StringBuilder currentCode, PPE aPpe) {
        switch (aPpe) {
            case Glove glove -> {
    ...
    private void incrementForSanitizer(StringBuilder currentCode, Sanitizer aSanitizer) {
    ...
    private void incrementForSampleContainer(StringBuilder currentCode, SampleContainer aContainer) {
        switch (aContainer) {
    ...
    private void incrementForCultureMedia(StringBuilder currentCode, CultureMedia aCultureMedia) {
