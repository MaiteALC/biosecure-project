...
public class NumberUtils {
    ...
    /**
     * Validates a number, verifying if it is null or is out of min/max limits. If yes, an error will be added in the notification with an informative message and respective property name.
     * 
     * @param <T> a type which extends {@code Number}
    ...
    /**
     * Validates a number, verifying if it is out of min/max limits. If yes, an error will be added in the notification with an informative message and respective property name.
     * 
     * @param number the value that will be validated (can be null)
     * @param minValue minimum value to be accepted <strong>(exclusive)</strong>
     * @param propertyName name that will be included in notification errors (if there is)
