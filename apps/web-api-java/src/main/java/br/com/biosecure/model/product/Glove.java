...
public class Glove extends PersonalProtectiveEquipment {
    ...
    public Glove(String name, double price, String manufacturer, String batchNumber, LocalDate expirationDate, PackagingType packagingType, MeasureUnit measureUnit, int qtdPerPackage, Size size, String certificateOfApproval, boolean isDisposable, boolean isPowderFree, boolean hasLongBarrel, GloveMaterial material, boolean isTextured, double thicknessMils) {
        
        super(name, price, manufacturer, batchNumber, expirationDate, packagingType, measureUnit, qtdPerPackage, size, certificateOfApproval, isDisposable);
