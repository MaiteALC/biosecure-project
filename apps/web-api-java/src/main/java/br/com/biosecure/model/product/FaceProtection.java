...
public class FaceProtection extends PersonalProtectiveEquipment {
    ...
    public FaceProtection(String name, double price, String manufacturer, String batchNumber, LocalDate expirationDate, PackagingType packagingType, MeasureUnit measureUnit, int qtdPerPackage, Size size, String certificateOfApproval, boolean isDisposable, ProtectionType type, String standardRating, boolean isAntiFog) {
